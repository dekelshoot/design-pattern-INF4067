...
import com.vehicule.Patrons.FactoryMethod.*;
...
public class Clients {
    public static void main(String[] args) {
        ...
        LiassViergeDocuments liassDocuments = directeur.construiLiasseDocuments(commande);
        liassDocuments.afficherLiassDocument();
